...
<html>
    ...
    <body>
        ...
        <section id="intro" class="intro-section" style="background-image : url('https://i.ytimg.com/vi/TirVCqYdBm0/maxresdefault.jpg')">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <!-- Ubacen BXSlider-->
                        <div id="wrapper_slider" class="responsive">
    ...
    <section id="rezervacija" class="about-section">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
...
<!-- Filmovi Section -->
<section id="filmovi" class="services-section">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h1>Filmovi</h1>
...
<!-- Bioskopi Section -->
<section id="bioskopi" class="contact-section">
    <div class="container">
        <div class="row">
    ...
    <div class="modal-dialog">
        <div class="registermodal-container">
            ...
            <form>
                ...
                <input type="submit" name="register" class="register registermodal-submit" value="Registracija" id="sbmRegistracija">
            </form>
